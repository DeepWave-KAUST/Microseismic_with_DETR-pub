    ...
    def forward(self, outputs, labels_cls, labels_loc):
        ...
        Params:
            outputs: This is a dict that contains entries:
                ...
                "pred_locations": tensor of dim [batch_size, num_queries, 2] with the predicted source locations (X & Z)

            labels_cls: tensor of dim [batch_size, num_queries, 1] containing the class labels

            labels_loc: tensor of dim [batch_size, num_queries, 2] containing the target locations
        ...
        # predicted locations for each query, size of (batch_size, num_queries, 2) where 2 represents X and Z locations
